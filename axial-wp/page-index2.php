                            ...
                            <div class="thumb swiper-slide">
                                <div class="media">
                                    <picture>
                                        ...
                                        <img class="lazy" data-src="<?php echo get_template_directory_uri(); ?>/img/placeholder.jpg" src="<?php echo get_template_directory_uri(); ?>/img/placeholder.jpg" alt="thumb" />
                                    </picture>
                                </div>
                            ...
                            <li class="main_list-item">
                                ...
                                <div class="wrapper">
                                    ...
                                    <p class="text" data-aos="fade-up" data-aos-delay="200">
                                        Ullamcorper dignissim cras lobortis feugiat vivamus risus
                                    </p>
                                </div>
                            </li>
                            <li class="main_list-item">
                    ...
                    <div class="feedback_slider swiper">
                        <div class="swiper-wrapper">
                            <div class="feedback_slider-slide swiper-slide">
                                <p class="main">
                                    Consequat nisl vel pretium lectus quam id leo. Mauris augue neque gravida in fermentum et sollicitudin
                                    ac orci. Blandit libero volutpat sed cras ornare
                                </p>
                                <div class="media">
                                    <div class="avatar">
                                        <picture>
